...
public class CreatePostRequest implements ag.act.dto.HtmlContent {
  ...
  private Boolean isExclusiveToHolders = true;
  ...
  @Valid
  private List<@Valid CreatePollRequest> polls;

  private CreateDigitalProxyRequest digitalProxy;

  private CreateDigitalDocumentRequest digitalDocument;

  private Boolean isEd = false;

  public CreatePostRequest boardCategory(String boardCategory) {
  ...
  */
  ...
  public CreatePostRequest isAnonymous(Boolean isAnonymous) {
  ...
  */
  ...
  public CreatePostRequest isActive(Boolean isActive) {
  ...
  */
  ...
  public CreatePostRequest isNotification(Boolean isNotification) {
  ...
  */
  ...
  public CreatePostRequest isExclusiveToHolders(Boolean isExclusiveToHolders) {
  ...
  */
  ...
  public CreatePostRequest imageIds(List<Long> imageIds) {
    this.imageIds = imageIds;
    return this;
  }

  public CreatePostRequest addImageIdsItem(Long imageIdsItem) {
  ...
  /**
   * IDs of images included in the post
   * @return imageIds
  */
  ...
  public CreatePostRequest activeStartDate(java.time.Instant activeStartDate) {
  ...
  */
  ...
  public CreatePostRequest activeEndDate(java.time.Instant activeEndDate) {
  ...
  */
  ...
  public CreatePostRequest push(PushRequest push) {
    this.push = push;
    return this;
  }
  ...
  */
  ...
  public CreatePostRequest polls(List<@Valid CreatePollRequest> polls) {
    this.polls = polls;
    return this;
  }

  public CreatePostRequest addPollsItem(CreatePollRequest pollsItem) {
    if (this.polls == null) {
  ...
  */
  @Valid 
  @JsonProperty("polls")
  public List<@Valid CreatePollRequest> getPolls() {
    return polls;
  }

  public void setPolls(List<@Valid CreatePollRequest> polls) {
    this.polls = polls;
  }

  public CreatePostRequest digitalProxy(CreateDigitalProxyRequest digitalProxy) {
  ...
  */
  ...
  public CreateDigitalProxyRequest getDigitalProxy() {
    return digitalProxy;
  }

  public void setDigitalProxy(CreateDigitalProxyRequest digitalProxy) {
    this.digitalProxy = digitalProxy;
  }

  public CreatePostRequest digitalDocument(CreateDigitalDocumentRequest digitalDocument) {
  ...
  */
  ...
  public CreateDigitalDocumentRequest getDigitalDocument() {
    return digitalDocument;
  }

  public void setDigitalDocument(CreateDigitalDocumentRequest digitalDocument) {
    this.digitalDocument = digitalDocument;
  }

  public CreatePostRequest isEd(Boolean isEd) {
    this.isEd = isEd;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.boardCategory, createPostRequest.boardCategory) &&
        Objects.equals(this.title, createPostRequest.title) &&
        Objects.equals(this.content, createPostRequest.content) &&
        Objects.equals(this.isAnonymous, createPostRequest.isAnonymous) &&
        Objects.equals(this.isActive, createPostRequest.isActive) &&
        Objects.equals(this.isNotification, createPostRequest.isNotification) &&
        Objects.equals(this.isExclusiveToHolders, createPostRequest.isExclusiveToHolders) &&
        Objects.equals(this.imageIds, createPostRequest.imageIds) &&
        Objects.equals(this.activeStartDate, createPostRequest.activeStartDate) &&
        Objects.equals(this.activeEndDate, createPostRequest.activeEndDate) &&
        Objects.equals(this.push, createPostRequest.push) &&
        Objects.equals(this.polls, createPostRequest.polls) &&
        Objects.equals(this.digitalProxy, createPostRequest.digitalProxy) &&
        Objects.equals(this.digitalDocument, createPostRequest.digitalDocument) &&
        Objects.equals(this.isEd, createPostRequest.isEd);
  }

  @Override
  public int hashCode() {
    return Objects.hash(boardCategory, title, content, isAnonymous, isActive, isNotification, isExclusiveToHolders, imageIds, activeStartDate, activeEndDate, push, polls, digitalProxy, digitalDocument, isEd);
  }
