...
public class CommonApiController implements CommonApi {
    ...
    public CommonApiController(@Autowired(required = false) CommonApiDelegate delegate) {
        this.delegate = Optional.ofNullable(delegate).orElse(new CommonApiDelegate() {});
    }

    @Override
    public CommonApiDelegate getDelegate() {
        return delegate;
    }
