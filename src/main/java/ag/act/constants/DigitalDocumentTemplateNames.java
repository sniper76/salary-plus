...
public interface DigitalDocumentTemplateNames {
    ...
    String OTHER_DOCUMENT_CERTIFICATION_TEMPLATE = "other-document-certification.ftlh";
    String HOLDER_LIST_READ_AND_COPY_TEMPLATE = "holder-list-read-and-copy-v1.1.ftlh";
}
