...
import static ag.act.enums.download.matrix.UserRetentionWeeklyCsvDataType.PIN_VERIFICATION_FOR_THREE_WEEKS_IN_A_ROW_GIVEN_REGISTER_AND_NO_DIGITAL_DOCUMENT_COMPLETE;
...
@Component
public class PinVerificationForThreeWeeksInARowGivenRegisterAndNoDigitalDocumentCompleteByWeekProvider
    extends UserRetentionDataByWeekProvider<UserRetentionDataByWeekProviderRequest> {
    public PinVerificationForThreeWeeksInARowGivenRegisterAndNoDigitalDocumentCompleteByWeekProvider(
    ...
    public boolean supports(UserRetentionWeeklyCsvDataType userRetentionWeeklyCsvDataType) {
        return PIN_VERIFICATION_FOR_THREE_WEEKS_IN_A_ROW_GIVEN_REGISTER_AND_NO_DIGITAL_DOCUMENT_COMPLETE
        ...
        Stream.iterate(
            ...
            .forEach(week -> {
                double activeUserCountDuringThreeWeeks = userVerificationHistoryService
                    .countNoDigitalDocumentCompletedUserPinVerificationForThreeWeeksInARow(
