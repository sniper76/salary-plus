...
@Component
public class IsSuperAdminGuard implements ActGuard {

    private final UserRoleService userRoleService;

    public IsSuperAdminGuard(UserRoleService userRoleService) {
    ...
    public void canActivate(Map<String, Object> parameterMap) throws ActRuntimeException {
        ...
        if (!userRoleService.isSuperAdmin(userId)) {
            throw new BadRequestException("슈퍼 관리자만 가능한 기능입니다.");
        }
    }
}
