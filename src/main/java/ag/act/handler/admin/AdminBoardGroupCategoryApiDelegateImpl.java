...
import ag.act.api.AdminBoardGroupCategoryApiDelegate;
...
public class AdminBoardGroupCategoryApiDelegateImpl implements AdminBoardGroupCategoryApiDelegate {
    private final BoardService boardService;
    private final VirtualBoardService virtualBoardService;

    @Override
    public ResponseEntity<BoardCategoryDataArrayResponse> getBoardGroupCategoriesAdmin(String boardGroupName) {
