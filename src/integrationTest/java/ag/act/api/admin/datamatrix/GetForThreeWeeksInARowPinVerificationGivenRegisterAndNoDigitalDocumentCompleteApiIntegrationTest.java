...
public class GetForThreeWeeksInARowPinVerificationGivenRegisterAndNoDigitalDocumentCompleteApiIntegrationTest
    ...
    private String scenarioForWeek1RegisteredUsers() {
        ...
        addToList(expectedRow1Cells, 2); // user4, user5
        ...
        addToList(expectedRow1Cells, 1); // user4
        ...
        LocalDate week8 = week7.plusWeeks(1); // user4
    ...
    private String scenarioForWeek2RegisteredUsers() {
        ...
        addToList(expectedRow2Cells, 4); // user4, user5, user6, user7

        LocalDate week3 = week2.plusWeeks(1);
        verificationForThreeWeeksInARow(user1, week3);
        verificationForThreeWeeksInARow(user3, week3);

        addToList(expectedRow2Cells, 2); // user4, user5
