...
class GetWeeklyPinVerificationGivenRegisterAndSpecificDigitalDocumentNotCompleteApiIntegrationTest
    ...
    private final LocalDateTime digitalDocumentTargetEndDateTime =
        digitalDocumentTargetStartDateTime.plusWeeks(DIGITAL_DOCUMENT_PROGRESS_PERIOD);
