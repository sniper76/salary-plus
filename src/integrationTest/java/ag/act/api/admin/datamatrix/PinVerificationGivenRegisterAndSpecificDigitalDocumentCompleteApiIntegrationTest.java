...
class PinVerificationGivenRegisterAndSpecificDigitalDocumentCompleteApiIntegrationTest
    ...
    private static final int DIGITAL_DOCUMENT_PROGRESS_PERIOD = 2;
    private static final int HEADER_ROW_COUNT = 1;
    private static final int EXPECTED_ROW_COUNT = HEADER_ROW_COUNT + DIGITAL_DOCUMENT_PROGRESS_PERIOD + 1;
    // header + digital document progress period + extra row because digital document start before friday
    ...
    private final LocalDateTime digitalDocumentTargetEndDateTime = digitalDocumentTargetStartDateTime
        .plusWeeks(DIGITAL_DOCUMENT_PROGRESS_PERIOD);
    ...
    private String scenarioForWeek1() {
        ...
        registerAt(user1, digitalDocumentStartDate);
    ...
    private String callApiAndGetResult() throws Exception {
        MvcResult mvcResult = mockMvc
            .perform(
                get(TARGET_API, digitalDocument.getId())
