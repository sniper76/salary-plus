...
public class GetWeeklyPinVerificationGivenFirstDigitalDocumentCompleteApiIntegrationTest
    ...
    private String scenarioForWeek1() {
        ...
        addToList(expectedRow1Cells, 3); // user1 and user2 and user3 saved digital document during week1 and retained
        ...
        addToList(expectedRow1Cells, 2); // user1 and user2 saved digital document during week1 and retained

        LocalDate week3 = week2.plusWeeks(1);
        verificationDuringWeek(user1, week3);
        verificationDuringWeek(user3, week3);

        addToList(expectedRow1Cells, 2); // user1 and user3 saved digital document during week1 and retained

        LocalDate week4 = week3.plusWeeks(1);
        verificationDuringWeek(user4, week4);
        verificationDuringWeek(user5, week4);

        addToList(expectedRow1Cells, 0); // no one saved digital document during week1
        ...
        addToList(expectedRow1Cells, 1); // user1 saved digital document during week1 and retained
        ...
        addToList(expectedRow1Cells, 3); // user1, user2, user3 saved digital document during week1 and retained
    ...
    private String scenarioForWeek2() {
        ...
        addToList(expectedRow2Cells, 3); // user1, user2, user3 saved digital document during week2
        ...
        addToList(expectedRow2Cells, 2); // user1, user3 saved digital document during week2 and retained

        LocalDate week4 = week3.plusWeeks(1);
        verificationDuringWeek(user4, week4);
        verificationDuringWeek(user5, week4);

        addToList(expectedRow2Cells, 0); // no one saved digital document during week2
        ...
        addToList(expectedRow2Cells, 1); // user1 saved digital document during week2 and retained
        ...
        addToList(expectedRow2Cells, 3); // user1, user2, user3 saved digital document during week2 and retained
