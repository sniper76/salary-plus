...
class GetWeeklyDigitalDocumentParticipationRateGivenRegisterApiIntegrationTest extends AbstractGetUserRetentionWeeklyCsvApiIntegrationTest {
    ...
    private String scenarioForWeek1RegisteredUsers() {
        ...
        verificationDuringWeek(user1, week1);
        verificationDuringWeek(user2, week1);
        verificationDuringWeek(user3, week1);
        verificationDuringWeek(user4, week1);
        verificationDuringWeek(user5, week1);
        ...
        addToList(expectedRow1Cells, 3.0 / 5.0); // 5 active users. user1 and user2 and user3 saved digital document among them
        ...
        addToList(expectedRow1Cells, 2.0 / 3.0); // 3 active users. user1 and user2 saved digital document among them

        LocalDate week3 = week2.plusWeeks(1);
        verificationDuringWeek(user1, week3);
        verificationDuringWeek(user3, week3);

        addToList(expectedRow1Cells, 1); // 2 active users. user1 and user3 saved digital document among them

        LocalDate week4 = week3.plusWeeks(1);
        verificationDuringWeek(user4, week4);
        verificationDuringWeek(user5, week4);

        addToList(expectedRow1Cells, 0); // 2 active users. no one saved digital document among them
        ...
        addToList(expectedRow1Cells, 1.0 / 3.0); // 3 active users. user1 saved digital document among them
        ...
        addToList(expectedRow1Cells, 3.0 / 5.0); // 5 active users. user1, user2, user3 saved digital document among them
    ...
    private String scenarioForWeek2RegisteredUsers() {
        ...
        addToList(expectedRow2Cells, 3.0 / 7.0); // 7 active users. user1 and user2 and user3 saved digital document among them

        LocalDate week3 = week2.plusWeeks(1);
        verificationDuringWeek(user1, week3);
        verificationDuringWeek(user3, week3);

        addToList(expectedRow2Cells, 1); // 2 active users. user1 and user3 saved digital document among them

        LocalDate week4 = week3.plusWeeks(1);
        // now, user4 also saved digital document
        digitalDocumentSaveDuringWeek(user4, week4);

        verificationDuringWeek(user4, week4);
        verificationDuringWeek(user5, week4);

        addToList(expectedRow2Cells, 1.0 / 2.0); // 2 active users. user4 saved digital document among them
        ...
        addToList(expectedRow2Cells, 2.0 / 3.0); // 3 active users. user1 and user2 saved digital document among them
        ...
        addToList(expectedRow2Cells, 4.0 / 7.0); // 7 active users. user1, user2, user3, user4 saved digital document among them
