...
public class GetWeeklyPinVerificationGivenRegisterAndNoDigitalDocumentCompleteApiIntegrationTest
    ...
    private String scenarioForWeek1() {
        ...
        addToList(expectedRow1Cells, 2); // user4 and user5 did not save digital document and retained
        ...
        addToList(expectedRow1Cells, 1); // user4 did not save digital document and retained

        LocalDate week3 = week2.plusWeeks(1);
        verificationDuringWeek(user1, week3);
        verificationDuringWeek(user3, week3);

        addToList(expectedRow1Cells, 0); // no user who did not save digital document retained
    ...
    private String scenarioForWeek2() {
        ...
        addToList(expectedRow2Cells, 4); // user4, user5, user6, user7 did not save digital document
        ...
        addToList(expectedRow2Cells, 4); // user4, user5, user6, user7 did not save digital document and retained

        LocalDate week4 = week3.plusWeeks(1);
        verificationDuringWeek(user4, week4);
        verificationDuringWeek(user5, week4);

        addToList(expectedRow2Cells, 2); // user4, user5 did not save digital document and retained
