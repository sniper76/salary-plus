...
class PostsDuplicateApiIntegrationTest extends AbstractCommonIntegrationTest {
    ...
    private void assertValidBoardPostsFromDatabase(List<Long> boardIds) {
        for (Long boardId : boardIds) {
            ...
            if (isEctDigitalDocument(duplicatedPost)) {
    ...
    private boolean isEctDigitalDocument(Post duplicatedPost) {
