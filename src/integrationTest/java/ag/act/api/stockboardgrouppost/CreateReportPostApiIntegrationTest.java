...
class CreateReportPostApiIntegrationTest extends AbstractCommonIntegrationTest {

    private static final String TARGET_API = "/api/stocks/{stockCode}/board-groups/{boardGroupName}/posts/{postId}/reports";
    ...
    class WhenCreatePostReport {
        ...
        void shouldReturnSuccess() throws Exception {
            ...
            assertThat(getResultObject(post.getId()), is(true));
        }
