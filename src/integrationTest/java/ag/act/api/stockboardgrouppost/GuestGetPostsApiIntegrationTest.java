...
class GuestGetPostsApiIntegrationTest extends AbstractCommonIntegrationTest {
    ...
    class GetPostsInWeb {
        ...
        class GetActGlobalBoardGroupPosts {
            ...
            class WhenGlobalBoard {
                ...
                class AndAllCategory {
                    ...
                    void shouldReturnSuccess() throws Exception {
                        final GetBoardGroupPostResponse result = callApiAndGetResponse(BoardGroup.GLOBALBOARD.name(), status().isOk());
            ...
            class WhenGlobalEvent {
                ...
                class AndEventAndCampaignCategory {
                    ...
                    @Test
                    void shouldReturnSuccess() throws Exception {
                        final GetBoardGroupPostResponse result = callApiAndGetResponse(BoardGroup.GLOBALEVENT.name(), status().isOk());
            ...
            class WhenGlobalCommunity {
                ...
                @Test
                void shouldReturnSuccess() throws Exception {
                    final GetBoardGroupPostResponse result = callApiAndGetResponse(board.getGroup().name(), status().isOk());
        ...
        class GetActBestPosts {
            ...
            @Test
            void shouldReturnSuccess() throws Exception {
                final GetBoardGroupPostResponse result = callApiAndGetResponse(VirtualBoardGroup.ACT_BEST.name(), status().isOk());
    ...
    private GetBoardGroupPostResponse callApiAndGetResponse(String boardGroupName, ResultMatcher resultMatcher) throws Exception {
        return callApiAndGetResponse(boardGroupName, null, resultMatcher);
    }
    ...
    private GetBoardGroupPostResponse callApiAndGetResponse(
        ...
        MvcResult result = callApi(boardGroupName, boardCategoryName, AbstractCommonIntegrationTest.X_APP_VERSION_WEB, resultMatcher);
